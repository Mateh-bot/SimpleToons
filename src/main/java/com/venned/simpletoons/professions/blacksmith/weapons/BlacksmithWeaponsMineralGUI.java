...
public class BlacksmithWeaponsMineralGUI {
    private static final String[] minerals = {"Bronze", "Iron", "Steel"};

    public static Inventory getMineralInventory() {
        Inventory inv = Bukkit.createInventory(null, 9, ChatColor.DARK_GRAY + "Weapons - Choose Mineral");
        int[] slots = {2, 4, 6};
    ...
    private static ItemStack createMineralItem(String mineral) {
        ...
        meta.setLore(Arrays.asList(ChatColor.GRAY + "Click to view weapon recipes"));
